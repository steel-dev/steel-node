...
export class BrowserTools extends APIResource {
   ...
   */
  scrape(body: BrowserToolScrapeParams, options?: Core.RequestOptions): Core.APIPromise<ScrapeResponse> {
...
export namespace BrowserTools {
  export import ScrapeResponse = BrowserToolsAPI.ScrapeResponse;
